...
#if defined(NDEBUG)
# error "Qnodecoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Qnodecoin Signed Message:\n";
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck)
{
    ...
    // Qnodecoin also requires DER encoding of pubkeys
    flags |= SCRIPT_VERIFY_DERKEY;
    // Qnodecoin also requires low S in sigs
