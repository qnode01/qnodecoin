 ...
 * between qnodecoind, and qnodecoin-qt and non-server tools.
*/
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/qngnode/qnodecoin/xqn>";
    ...
    return FormatParagraph(strprintf("Copyright (C) %i-%i The Bitcoin Core Developers", 2009, COPYRIGHT_YEAR)) + "\n" +
           ...
           "\n" +
           FormatParagraph(strprintf("Copyright (C) %i The Qnodecoin Developers", 2024)) + "\n" +
           "\n" +
           FormatParagraph(strprintf(_("Please contribute if you find Qnodecoin useful. "
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Qnodecoin More version %s\n", FormatFullVersion());
}
