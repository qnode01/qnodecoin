...
UniValue dumpprivkey(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "dumpprivkey \"qnodecoinaddress\"\n"
            "\nReveals the private key corresponding to 'qnodecoinaddress'.\n"
            "Then the importprivkey can be used with this output\n"
            "\nArguments:\n"
            "1. \"qnodecoinaddress\"   (string, required) The qnodecoin address for the private key\n"
            "\nResult:\n"
