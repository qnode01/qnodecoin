...
These are the dependencies currently used by Qnodecoin. You can find instructions for installing them in the `build-*.md` file for your platform.
...
Telegram - https://t.me/qnodecoinnl
Keybase  - https://keybase.io/team/qnodecoin/
